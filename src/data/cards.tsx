import { IconApi, IconBrandBootstrap, IconBrandCss3, IconBrandHtml5, IconBrandJavascript, IconBrandNextjs, IconBrandReact, IconBrandTailwind } from "@tabler/icons-react";
...
export const cards = [
    ...
    },
    {
        ...
        description: "Este projeto representa a concepção, planejamento e implementação de um website para uma Organização Não Governamental (ONG), desde a fase inicial até a entrega final, resultado de um trabalho voluntário. ",
