    ...
    <section id="home" className={props.className}>
      <div className="space-y-5 mt-24 py-2 sm:mt-0">
        ...
        <p className="text-xl font-light max-w-[600px] sm:text-2xl">
          Cursando análise e desnvolvimento de sistemas e me especializando com
          a Formação.Dev na Cod3rcursos.
        </p>
      ...
      <button
        className="animate-bounce w-10 h-10 btn rounded-full mt-10 sm:mt-20"
        onClick={scrollToProjects}
      >
        <span className="uppercase text-sm flex flex-col items-center gap-1">
          <IconArrowDown />
        </span>
      </button>
    </section>
