        ...
        <div className="custom-shadow  p-2 rounded-lg">
            <div className="flex items-center justify-between px-2">
                ...
                <div className="flex gap-5 items-center">
                    <a href={code} target="_blank" title="Ver código"
                        className={`rounded-full custom-shadow  
                        ${code ? "hover " : "p-1 pointer-events-none text-zinc-500"}`}><IconCode /></a>
                    <a href={deploy} target="_blank" title="Ver site"
                        className="rounded-full hover custom-shadow "><IconLink /></a>
                </div>
            </div>
