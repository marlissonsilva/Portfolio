  ...
  return (
    <>
      <Head>
        ...
        <title>Marlisson Silva/Portfolio</title>
      </Head>
      <div className={` ${theme}`}>
        <main className=" text-zinc-800 dark:bg-zinc-800 dark:text-zinc-300 relative">
          <Header onClick={handleChangeTheme} theme={theme} className="fixed w-full z-10 bg-white dark:bg-zinc-800"/>
          <Banner className="section h-screen max-h-[1200px] " />
